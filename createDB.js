...
function startup() {
        ...
        db.run("create table news (title NOT NULL, content, imgDir, date NOT NULL, constraint pk_news PRIMARY KEY (title, date))", err);
        ...
        var img1 = "img/Dogs/Kobi/Kobi_birthday.png";
        ps.run(title1, content1, img1);
